    ...
    return (
        ...
        <section className="relative px-6 pt-32 pb-20 overflow-hidden" >
            <div className="max-w-4xl mx-auto text-center">
                ...
                <h1 className="mb-4 text-4xl font-black tracking-tight md:text-5xl lg:text-6xl text-brand-white font-poppins animate-fade-in-up">
                ...
                <p className="max-w-3xl mx-auto mb-8 text-base leading-relaxed md:text-lg text-brand-light-gray animate-fade-in-up animation-delay-300">
                ...
                <div className="flex flex-wrap justify-center gap-4 animate-fade-in-up animation-delay-400">
                    ...
                    <Link
                        href="#contact"
                        className="inline-flex items-center gap-2 px-8 py-4 font-bold transition-all duration-300 border-2 rounded-full text-brand-crimson-red border-brand-crimson-red hover:bg-brand-crimson-red hover:text-brand-white hover:scale-105 group"
                    >
                        <Mail size={20} />
                        Contact Me
                    </Link>
